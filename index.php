...
<html lang="en">
  ...
  ?>
      ...
      <div class="container-fluid">
            ...
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-left">
                <br><br>
                <h5 align="left"><i>&nbsp;&nbsp;Your life, your money, your bank.</i></h5>
                <h6 align="center"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- The Sparks Foundation Bank &nbsp;</i></h6>
              </div>
              <div class="img"><img src="images/bank.png" alt="SF Bank" width=330px height=207.5px></div>
            </div>

          <br>
          <h3 class="action"><span style="font-family: Trebuchet MS">Choose an action</h3></span>
      ...
      <footer class="text-right mt-5 py-2">
        <p><h6 align="center">A Project by <b>Nakul Shah</h6></b></p>
      </footer>
